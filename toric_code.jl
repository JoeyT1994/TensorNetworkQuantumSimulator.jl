...
function get_flat_vertex()
    ...
    site_ten = Adapt.adapt(Int64,delta(myinds[1], myinds[1]', myinds[5]) * delta(myinds[2],myinds[2]', myinds[6]) * delta(myinds[3], myinds[3]',myinds[7]) * delta(myinds[4], myinds[4]',myinds[8]) * x_spider * x_spider')
    return site_ten
end
